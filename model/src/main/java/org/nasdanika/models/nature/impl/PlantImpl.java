 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.nature.impl.PlantImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlantImpl extends MinimalEObjectImpl.Container implements Plant {
	...
	protected EClass eStaticClass() {
		return NaturePackage.Literals.PLANT;
	}
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NaturePackage.PLANT__COLOR, oldColor, color));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NaturePackage.PLANT__COLOR:
				return getColor();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case NaturePackage.PLANT___COMMUNICATE:
				communicate();
				return null;
		}

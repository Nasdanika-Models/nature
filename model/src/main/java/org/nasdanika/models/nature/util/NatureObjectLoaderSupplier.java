 ...
 *
 */
public class NatureObjectLoaderSupplier extends NatureObjectLoaderExecutionParticipant implements Supplier<EObject> {

	private URI uri;
	
	public NatureObjectLoaderSupplier(URI uri, Context context) {
		super(context);
		this.uri = uri;
	}
	...
	public static EObject loadObject(
		...
		try {
			try (NatureObjectLoaderSupplier appObjectLoaderSupplier = new NatureObjectLoaderSupplier(resourceURI, context)) {

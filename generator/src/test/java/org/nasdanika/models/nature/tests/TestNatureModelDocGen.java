package org.nasdanika.models.nature.tests;
...
import org.nasdanika.models.nature.processors.EcoreGenNatureProcessorsFactory;
...
public class TestNatureModelDocGen {
	...
	public void testGenerateNatureModelDoc() throws IOException, DiagnosticException {
		...
		EcoreGenNatureProcessorsFactory ecoreGenNatureProcessorFactory = new EcoreGenNatureProcessorsFactory(context);		
		EcoreNodeProcessorFactory ecoreNodeProcessorFactory = new EcoreNodeProcessorFactory(
				...
				diagnosticConsumer,
				ecoreGenNatureProcessorFactory);
		
		File actionModelsDir = new File("target\\action-models\\");
		actionModelsDir.mkdirs();
		File output = new File(actionModelsDir, "nature.xmi");
		...
		String siteMapDomain = "https://nature.models.nasdanika.org";		
